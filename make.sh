...
log()   { echo -e "\e[30;47m $(echo "$1" | tr 'a-z' 'A-Z') \e[0m ${@:2}"; }        # $1 uppercase background white
info()  { echo -e "\e[48;5;28m $(echo "$1" | tr 'a-z' 'A-Z') \e[0m ${@:2}"; }      # $1 uppercase background green
warn()  { echo -e "\e[48;5;202m $(echo "$1" | tr 'a-z' 'A-Z') \e[0m ${@:2}" >&2; } # $1 uppercase background orange
error() { echo -e "\e[48;5;196m $(echo "$1" | tr 'a-z' 'A-Z') \e[0m ${@:2}" >&2; } # $1 uppercase background red
